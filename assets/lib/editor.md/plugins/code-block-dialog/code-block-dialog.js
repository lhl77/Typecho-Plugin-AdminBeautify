...
(function() {
    ...
    var factory = function (exports) {
		...
		exports.fn.codeBlockDialog = function() {
			...
			// Do not force focus to main editor here, it can scroll the page unexpectedly.

			var bodyDialog = $("body").children("." + dialogName);

			if (editor.find("." + dialogName).length > 0 || bodyDialog.length > 0)
            {
