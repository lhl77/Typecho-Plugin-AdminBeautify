        ...
        <div style="margin-top:18px">
            ...
            <div id="ab-about-thanks" style="border-radius:12px;padding:12px;background:var(--md-surface-container-low);border:1px solid var(--md-outline-variant);">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:4px">
                    ...
                    <span style="display:inline-flex;align-items:center;gap:4px;padding:3px 12px;background:rgba(0,0,0,.06);border-radius:20px;font-size:12px;color:var(--md-on-surface)">感谢 <a href="http://www.loongmcu.com/" target="_blank" style="color:var(--md-primary,#6750a4);font-weight:600;text-decoration:none">言午</a> 的 5元 打赏</span>
                </div>
